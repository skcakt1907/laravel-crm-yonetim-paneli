...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('sayfalar')) {
            Schema::table('sayfalar', function (Blueprint $table) {
                // adi kolonu için çoklu dil (baslik yerine adi kullanılıyor)
                ...
                if (!Schema::hasColumn('sayfalar', 'icerik_en')) {
                    $table->longText('icerik_en')->nullable()->after('icerik');
                }
                if (!Schema::hasColumn('sayfalar', 'icerik_ar')) {
                    $table->longText('icerik_ar')->nullable()->after('icerik_en');
                }
            ...
            DB::statement("UPDATE sayfalar SET icerik_en = icerik, icerik_ar = icerik WHERE icerik_en IS NULL");
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('sayfalar')) {
            Schema::table('sayfalar', function (Blueprint $table) {
                $table->dropColumn(['baslik_en', 'baslik_ar', 'icerik_en', 'icerik_ar']);
            });
        }
    }
};
