...
@section('title', 'Web Paket Satışları')
...
<div class="breadcrumb">
    ...
    <span class="sep">/</span>
    <span class="current">Web Paket Satışları</span>
</div>
...
<div class="page-header">
    <div>
        ...
        <div class="page-subtitle">Müşterilerinizin satın aldığı web paketleri</div>
    </div>
...
@php
    ...
    try {
        if (\Schema::hasTable('satilanlar')) {
            $totalRow = \DB::table('satilanlar')->where('paket', '>', 0)
...
@if($satislar->isEmpty())
    <div class="section">
        <div class="empty-state">
            ...
            <h4>Henüz web paket satışı yok</h4>
            <p>Müşterileriniz web paketi satın aldığında burada listelenecek.</p>
        </div>
    </div>
@else
                ...
                <tbody>
                    @foreach($satislar as $s)
                        @php
                            ...
                            $urun = $s->urun ?? $s->paket_baslik ?? $s->paket_adi ?? '—';
