...
<title>Ürün Ekle — İş Ortağım Admin</title>
...
<div class="mb-6">
<div class="flex items-center gap-2 text-sm text-white/60 mb-2"><a href="{{ route('admin.dashboard') }}" class="hover:text-yellow-400">🏠</a> <span>›</span> <a href="{{ route('admin.urunler.index') }}" class="hover:text-yellow-400">📦 Ürün</a> <span>›</span> <span>Yeni</span></div>
<h1 class="font-display text-3xl font-extrabold flex items-center gap-3">➕ Yeni Ürün</h1>
</div>
<form action="{{ route('admin.urunler.eklePost') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
@csrf
<div class="glass rounded-2xl p-6">
<div class="section-title">📦 Ürün</div>
<div class="grid md:grid-cols-2 gap-5">
<div><label class="field-label">📛 Ürün Adı <span class="required">*</span></label><input type="text" name="adi" value="{{ old('adi') }}" required></div>
<div><label class="field-label">💰 Fiyat</label><input type="number" name="fiyat" value="{{ old('fiyat') }}"></div>
<div class="md:col-span-2"><label class="field-label">📝 Açıklama</label><textarea name="aciklama" rows="4">{{ old('aciklama') }}</textarea></div>
</div>
